          ...
          <div class="hidden md:flex-1 md:flex md:items-center md:justify-between">
            ...
            -->
                <div class="hidden md:block absolute z-10 top-full inset-x-0 transform shadow-lg bg-white">
                  ...
                  >
                    <a class="-m-3 p-3 flex flex-col justify-between rounded-lg hover:bg-gray-50">
                    ...
                    <div class="bg-gray-50 px-4 py-8 sm:py-12 sm:px-6 lg:px-8 xl:pl-12">
                      <div>
                        ...
                        <ul role="list" class="mt-6 space-y-6">
                          <li class="flow-root">
                            <a class="-m-3 p-3 flex rounded-lg hover:bg-gray-100">
            ...
            <div class="flex items-center md:ml-12">
              <button class="text-base font-medium text-gray-500 hover:text-gray-900">Sign in</button>
              <button
        ...
        <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
          ...
          <div class="py-6 px-5">
            <div class="grid grid-cols-2 gap-4">
              <a class="rounded-md text-base font-medium text-gray-900 hover:text-gray-700"> Pricing </a>

              <button class="rounded-md text-base font-medium text-gray-900 hover:text-gray-700">Docs</button>

              <a class="rounded-md text-base font-medium text-gray-900 hover:text-gray-700"> Company </a>

              <a class="rounded-md text-base font-medium text-gray-900 hover:text-gray-700"> Resources </a>

              <a class="rounded-md text-base font-medium text-gray-900 hover:text-gray-700"> Blog </a>

              <a class="rounded-md text-base font-medium text-gray-900 hover:text-gray-700"> Contact Sales </a>
            </div>
            <div class="mt-6">
              <a
