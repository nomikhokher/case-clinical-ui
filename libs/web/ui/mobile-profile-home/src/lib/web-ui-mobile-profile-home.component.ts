          ...
          ><div class="bg-white pt-8 dark:bg-gray-800">
            ...
            <nav class="flex space-x-4 ml-3 mt-9 dark:bg-gray-800">
              <a
                ...
                class="font-semibold text-lg pb-4 px-3 py-2 leading-3 dark:text-white"
                [ngClass]="{ 'border-b-2 border-black dark:border-gray-300': artWorkAction === true }"
                >Artworks</a
              >
              <a
                (click)="this.changeCollectionAction()"
                class="font-semibold gray-c px-2 py-2 text-lg leading-3 dark:text-white"
                [ngClass]="{ 'border-b-2 border-black dark:border-gray-300': collectionAction === true }"
                >Collection</a
              >
            </nav>
            <hr class="" />
            ...
            <div class="scroll-section">
              ...
              <div *ngIf="this.collectionAction == true">
                <div class="body-fon mt-4 px-3 mb-2">
                  <div class="">
                    <img
