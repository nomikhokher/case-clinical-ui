...
`,
  ...
  .set(
    ...
    `
    <svg
        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 fill-current text-gray-600
      >
        <path
...
`,
  ...
  .set(
    UiIcon.folderOpen,
    `
    <svg xmlns="http://www.w3.org/2000/svg" class="h-14 mb-4 w-14 text-blue-600 dark:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
