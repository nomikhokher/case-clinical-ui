...
`,
  ...
  .set(
    UiIcon.grin_hearts,
    `
     <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="grin-hearts" class="w-4 h-4 mr-2 fill-current" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
...
`,
  ...
  .set(
    UiIcon.gem,
    `
<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="gem" class="w-4 h-4 mr-2 fill-current" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
