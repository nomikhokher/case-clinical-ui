      ...
      <div class="absolute inset-0 overflow-hidden">
        ...
        <div class="fixed inset-y-0 right-0 pl-10 max-w-full flex">
          <div class="w-screen" [ngClass]="width ? width : 'max-w-md'">
            <div
              class="h-full flex flex-col py-6 bg-white shadow-xl "
              [ngClass]="!closeLayoutWithOverlay ? 'overflow-y-scroll' : 'overflow-hidden'"
            >
              <div class="px-4 sm:px-6">
                <div class="flex items-start justify-between">
...
export class WebUiSlideOverComponent {
  ...
  @Input() closeLayoutWithOverlay?: boolean
