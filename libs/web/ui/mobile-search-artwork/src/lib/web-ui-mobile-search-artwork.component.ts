    ...
    <div class="mx-auto dark:bg-gray-900 pt-12 mobile-section">
      <div class=" dark:bg-gray-900">
        ...
        <section class="scroll-section scroll-section-vertical ">
          <div class=" justify-between px-4 pt-4 items-center">
            <div class="">
              <img
            ...
            <div
              class="shadow-blue-100 shadow-xl  rounded-br-xl rounded-bl-xl  shadow-blue-500/20 rounded-lg dark:bg-gray-700"
            >
              <div class="shadow-blue-100 shadow-xl px-8 py-4 ">
                ...
                <h2 class="text-3xl font-bold dark:text-white  pt-4">Sugar Rush</h2>
              </div>
