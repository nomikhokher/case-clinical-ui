...
@Component({
  ...
  template: `
    <div class="h-full p-3 space-y-2 w-60 text-gray-800 dark:text-white dark:border-white ">
        ...
        <div class="flex items-center p-2 space-x-4">
          ...
          <div>
            ...
            <span class="flex items-center space-x-1">
              <a href="#" class="text-xs hover:underline text-gray-600 dark:text-white">View profile</a>
            </span>
          </div>
        </div>
        <div class="divide-y divide-gray-300">
          <ul class="pt-2 pb-4 space-y-1 text-sm">
            <li class="text-gray-900 dark:text-white " *ngFor="let item of menuItems">
              <hr />
