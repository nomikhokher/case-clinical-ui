...
@Component({
  ...
  template: `
    ...
    <div class="flex flex-col flex-auto items-center w-full h-screen min-w-0 bg-gray-200 dark:bg-gray-900">
      <div class="relative w-full dark:shadow-none print:hidden">
      ...
      <div class="flex flex-auto justify-center w-full sm:px-6 md:px-8 mt-20">
