        ...
        <div class="lg:flex flex-grow items-center" id="example-navbar-warning">
          <ul class="flex flex-col lg:flex-row list-none flex-center">
            <li class="nav-item" *ngFor="let button of buttons">
              <button
                type="button"
                class="mx-4 px-3 py-2 flex items-center text-xs uppercase focus:bg-indigo-400 active:bg-indigo-400 focus:outline-none hover:bg-indigo-400 font-bold leading-snug text-white hover:opacity-75"
                [title]="button.title"
              >
