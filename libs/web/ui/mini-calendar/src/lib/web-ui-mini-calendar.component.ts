...
export class WebUiMiniCalendarComponent {
  ngOnInit() {
    this.initDate()
    this.getNoOfDays()
  }
  ...
  public MONTH_SHORT_NAMES = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']
  public DAYS = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat']

  showDatepicker: boolean = false
  datepickerValue: any
  selectedDate: any = '2021-02-04'
