    ...
    <div id="header">
      ...
      >
        ...
        <span (clickOutside)="asideMobileWidth = 0">
          <aside
            class="sm:hidden flex flex-col aside-scrollbar w-{{
              asideMobileWidth
            }} transition-all ease-in-out duration-500  text-gray-900 leading-6 theme-bg-600 dark:theme-bg-900 fixed inset-y-0 overflow-x-hidden overflow-y-auto ring-2 ring-black ring-opacity-5 z-50 "
          >
            <div class="p-3 flex justify-center">
              <a href="/components" class="mt-3">
                <img *ngIf="logo" [attr.src]="logo" [attr.loading]="'lazy'" class="h-10" alt="App Logo" />
          ...
          <header class="flex-none w-full relative text-sm leading-6 font-medium py-5 theme-bg-100 dark:theme-bg-50 ">
            <div class="px-4">
              <div class="flex justify-between">
                <div
                  class="dark:hover:bg-gray-900 hover:bg-gray-300 hover:bg-opacity-50 rounded-full p-2"
                  (click)="asideBarWith()"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
