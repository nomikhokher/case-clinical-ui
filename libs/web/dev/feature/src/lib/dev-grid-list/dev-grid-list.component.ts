    ...
    <ng-container *ngIf="vm$ | async as vm">
      ...
      >
        ...
        >
          <section id="gridList">
            <div
              class="relative rounded-lg border border-gray-300 bg-white dark:bg-gray-800 px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500"
            >
              ...
              <div class="flex-1 min-w-0 ">
                <a href="javascript:viod(0)" class="focus:outline-none">
                  ...
                  <p class="text-sm font-medium text-gray-900 dark:text-gray-100">Leslie Alexander</p>
                  <p class="text-sm text-gray-500 dark:text-gray-300 truncate">Co-Founder / CEO</p>
                </a>
              </div>
            </div>
          </section>
          <section id="gridList1">
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                <a href="javascript:viod(0)" class="focus:outline-none">
                  <span class="absolute inset-0" aria-hidden="true"></span>
                  <p class="text-sm font-medium text-gray-900 dark:text-gray-100">Theresa Webb</p>
                  <p class="text-sm text-gray-500 dark:text-gray-300 truncate">Global Division Officer</p>
                </a>
              </div>
            </div>
          </section>
          <section id="gridList2">
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                <a href="javascript:viod(0)" class="focus:outline-none">
                  <span class="absolute inset-0" aria-hidden="true"></span>
                  <p class="text-sm font-medium text-gray-900 dark:text-gray-100">Courtney Henry</p>
                  <p class="text-sm text-gray-500 dark:text-gray-300 truncate">Investor Factors Associate</p>
                </a>
              </div>
            </div>
          </section>
          <section id="gridList3">
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                <a href="javascript:viod(0)" class="focus:outline-none">
                  <span class="absolute inset-0" aria-hidden="true"></span>
                  <p class="text-sm font-medium text-gray-900 dark:text-gray-100">Kristin Watson</p>
                  <p class="text-sm text-gray-500 dark:text-gray-300 truncate">Lead Security Associate</p>
                </a>
              </div>
            </div>
          </section>
