...
import { ApolloAngularSDK, Tenant, TenantRole } from '@schema-driven/web/core/data-access'
...
@Injectable()
export class AdminTenantDetailStore extends ComponentStore<TenantDetailState> {
